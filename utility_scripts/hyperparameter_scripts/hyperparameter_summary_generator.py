...
import pandas as pd
import re
from models.global_rnn.utility_scripts.hyperparameter_scripts.hyperparameter_config_reader import read_optimal_hyperparameter_values
...
input_path = 'Localised_Ensembles/results/optimized_configurations/'

output_path = 'Localised_Ensembles/results/optimized_configurations/aggregate_hyperparameter_configs/'
