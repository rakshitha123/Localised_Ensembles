# This will first tune the hyperparameters to train the RNN and then will connect to other scripts which will do forecasting, re-scaling and error calculating
import numpy as np
import tensorflow as tf
import argparse
import multiprocessing

from models.global_rnn.utility_scripts.persist_optimized_config_results import persist_results
from generic_model_tester import testing
from models.global_rnn.utility_scripts.hyperparameter_scripts.hyperparameter_config_reader import read_initial_hyperparameter_values
...
# stacking model
from models.global_rnn.rnn_architectures.stacking_model.stacking_model_trainer import \
    StackingModelTrainer as StackingModelTrainer

# import the cocob optimizer
from models.global_rnn.external_packages import cocob_optimizer

from models.global_rnn.configs.global_configs import hyperparameter_tuning_configs
from models.global_rnn.configs.global_configs import model_training_configs
...
optimized_config_directory = 'WeeklyForecasting/results/optimized_configurations/'
learning_rate = 0.0
...
def train_model(configs):
    ...
    error, error_list = model_trainer.train_model(return_dict, train_params)
...
if __name__ == '__main__':
    ...
    model_identifier = dataset_name + "_rnn_test"
