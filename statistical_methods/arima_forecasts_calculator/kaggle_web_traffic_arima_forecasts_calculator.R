library(forecast)
# read the data
kaggle_dataset <- read.csv(file = "Localised_Ensembles/datasets/text_data/kaggle_web_traffic/kaggle_web_traffic_dataset.txt", sep = ',', header = FALSE)
kaggle_dataset <- as.matrix(kaggle_dataset)

output_file_name = "Localised_Ensembles/results/arima_forecasts/kaggle_web_traffic_arima_forecasts.txt"
