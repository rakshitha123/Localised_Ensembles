# Error calculation of traditional univariate benchmarks such as ETS and ARIMA


library(smooth)

args <- commandArgs(trailingOnly = TRUE)
forecast_file = "results/ets_forecasts/kaggle_web_traffic_ets_forecasts.txt"
actual_forecasts_file = "datasets/text_data/kaggle_web_traffic/kaggle_web_traffic_results.txt"
original_data_file_name = "datasets/text_data/kaggle_web_traffic/kaggle_web_traffic_dataset.txt"
...
mean_MASE = mean(mase_vector, na.rm=TRUE)
median_MASE = median(mase_vector, na.rm=TRUE)
std_MASE = sd(mase_vector, na.rm=TRUE)
